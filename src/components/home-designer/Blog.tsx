...
const BLOG_POSTS = [
    ...
    },
    {
        ...
        excerpt: "Best practices for creating cloud-native applications that grow with your business.",
        category: "Development",
        date: "Dec 18, 2024",
        imageClass: "bg-accent/20",
        slug: "/blog/building-scalable-saas",
    },
    {
        id: "3",
        title: "Blockchain Beyond Cryptocurrency",
        excerpt: "Exploring real-world applications of blockchain technology in business.",
        category: "Innovation",
        date: "Dec 15, 2024",
                        ...
                        <div className="container-fluid p-0">
                            <div className="row g-0">
                                {BLOG_POSTS.map((post, idx) => (
                                    ...
                                    >
                                        <Link className="mxd-blog-preview__media" href={post.slug}>
                                            <BackgroundParallax
                                                className={`mxd-blog-preview__image ${post.imageClass} parallax-img-small`}
                                            />
                                            <div className="mxd-preview-hover">
                                                <i className="mxd-preview-hover__icon">
                                                    <svg width="38" height="21" viewBox="0 0 38 21" fill="none">
                                                        <path d="M19 0C11 0 4 5 1 11c3 6 10 11 18 11s15-5 18-11c-3-6-10-11-18-11zm0 18c-4 0-7-3-7-7s3-7 7-7 7 3 7 7-3 7-7 7zm0-11c-2 0-4 2-4 4s2 4 4 4 4-2 4-4-2-4-4-4z" fill="currentColor" />
                                                    </svg>
                                                </i>
                                            </div>
